...
<head>
    ...
    @livewireStyles
    <style>
        :root { --primary:#9b59b6;--primary-dark:#7b2d8e;--primary-light:#c39bd3;--pink:#e91e90;--pink-light:#f8c8dc;--pink-bg:#fdf2f8;--purple-bg:#f5f0ff;--sidebar-top:#4a1068;--sidebar-bottom:#2d0845;--accent:#d63384;--accent-light:#f0d0e0; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-3">
            ...
            {{-- 2. إدارة المستخدمين — super_admin فقط --}}
            ...
            <a href="{{ route('dashboard.events') }}" class="nav-link {{ request()->routeIs('dashboard.vip-booking') ? 'active' : '' }}">

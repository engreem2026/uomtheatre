                            ...
                            <form action="{{ route('dashboard.users.update', $user->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="password" class="form-control" placeholder="يترك فارغ اذا لم ترغب في التغير ">
                                    </div>
                                </div>
            ...
            <form action="{{ route('dashboard.users.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="example@uom.edu.iq" required>
                    </div>
                    <div class="mb-3">

...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('roles')->insert([
            ...
            ['id' => 2, 'name' => 'event_manager',    'display_name' => 'مسؤول الفعاليات (الإعلام)', 'description' => 'ينشئ ويعدل الفعاليات',            'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'name' => 'theater_manager',  'display_name' => 'مدير المسرح',              'description' => 'ينشر الفعاليات ويحجز مقاعد الوفود', 'created_at' => now(), 'updated_at' => now()],
        ...
        echo "✅ تم إنشاء 6 أدوار\n";

        // ============================================
        // 2. إنشاء حالات الفعاليات (8 حالات)
        // ============================================
        DB::table('statuses')->insert([
            ['id' => 1, 'name' => 'draft',        'display_name' => 'مسودة',        'description' => 'لسا ما جهزت',               'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'name' => 'added',        'display_name' => 'مضافة',        'description' => 'تم إضافتها من مدير الإعلام',  'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'name' => 'under_review', 'display_name' => 'قيد المراجعة', 'description' => 'مدير المسرح يراجعها',        'created_at' => now(), 'updated_at' => now()],
        ...
        echo "✅ تم إنشاء 8 حالات للفعاليات\n";
        ...
        echo "✅ تم إنشاء حساب مدير النظام (admin@uomtheatre.com / password123)\n";

        // ============================================
        // 4. إنشاء أقسام المسرح الستة
        // ============================================
        DB::table('sections')->insert([
            ['id' => 1, 'name' => 'A', 'is_vip' => false, 'total_seats' => 181, 'total_rows' => 12, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 2, 'name' => 'B', 'is_vip' => false, 'total_seats' => 174, 'total_rows' => 13, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 3, 'name' => 'C', 'is_vip' => false, 'total_seats' => 177, 'total_rows' => 13, 'created_at' => now(), 'updated_at' => now()],
        ...
        echo "✅ تم إنشاء 6 أقسام للمسرح\n";

        // ============================================
        // 5. إنشاء المقاعد (945 مقعد)
        // ============================================
        $seatMap = [
            1 => [1=>8, 2=>9, 3=>10, 4=>11, 5=>13, 6=>14, 7=>15, 8=>17, 9=>18, 11=>21, 12=>22, 13=>23],
            2 => [1=>10, 2=>11, 3=>11, 4=>12, 5=>12, 6=>13, 7=>13, 8=>14, 9=>14, 11=>15, 12=>16, 13=>16, 14=>17],
            3 => [1=>10, 2=>10, 3=>11, 4=>12, 5=>12, 6=>13, 7=>13, 8=>14, 9=>15, 11=>16, 12=>16, 13=>17, 14=>18],
        ...
        foreach ($seatMap as $sectionId => $rows) {
            ...
            echo "✅ القسم {$sectionName}: " . count($seats) . " مقعد\n";
        }

        echo "\n🎉 تم إنشاء {$totalSeats} مقعد في 6 أقسام\n";
        echo "🎭 نظام حجز مقاعد مسرح جامعة الموصل جاهز!\n";
    }
}

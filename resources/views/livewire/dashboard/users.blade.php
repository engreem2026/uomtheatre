        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($user->is_active)
                        <button class="btn btn-sm btn-outline-danger" wire:click="toggleStatus({{ $user->id }})" wire:confirm="هل تريد تعطيل حساب {{ $user->name }}؟" title="تعطيل">
                            <i class="bi bi-person-x"></i>
                        </button>
                        @else
                        <button class="btn btn-sm btn-outline-success" wire:click="toggleStatus({{ $user->id }})" wire:confirm="هل تريد تفعيل حساب {{ $user->name }}؟" title="تفعيل">
